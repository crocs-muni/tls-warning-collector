...
# Cases for test of bad SSL certificates
$Cases = @(
...
# Browsers we want to run the tests on
$BrowserIDs = @(
"firefox"
#    ,
#   "chromium"
...
$Browsers = @{
    "firefox" = @{
        "name" = "Mozilla Firefox"; "package" = "firefox"; "binary" = "firefox"; "altbinary" = "firefox";
    ...
    "chromium" = @{
        "name" = "Chromium"; "package" = "chromium"; "binary" = "chrome";
    ...
    "chrome" = @{
        "name" = "Google Chrome"; "package" = "googlechrome"; "binary" = "chrome";
    ...
    "ie" = @{
        "name" = "Internet Explorer"; "package" = "ie11";
        "binary" = "ie";
    ...
    "edge" = @{
        "name" = "Microsoft Edge"; "package" = "edge";
        "binary" = "edge";
        "versions" = @("44")
    }
};

# Main function which installs the browser, gets screenshot and uninstall browser
function Main
{
...
# Removing items after uninstall
...
# Creating new directory if it does not already exist
...
# Installs browser with specified version
...
# Calls python script for getting screenshot
