...
# First set the right execution policy
# https:/go.microsoft.com/fwlink/?LinkID=135170
# Run below line as Administrator
# Set-ExecutionPolicy RemoteSigned
# If still not working, go to file properties and Allow it to run bz checking the checkbox
# Install python and set path - setx PATH <path-to-python> (usually C:\Users\<username>\AppData\Local\Programs\Python\...)

# choco install -y firefox --version=62.0
# choco uninstall -y firefox

# [system.Diagnostics.Process]::Start("firefox","https://expired.badssl.com/")
# Start-Process -FilePath firefox -ArgumentList "https://expired.badssl.com/"

# Download screenshot script here
# https://gallery.technet.microsoft.com/scriptcenter/Get-screenshot-to-image-0b5a410d
# Unblock the script
# Unblock-File .\Get-ScreenShot.ps1
# Import-Module .\Get-ScreenShot.ps1
# Get-ScreenShot -Path D:\downloads\ -FileName PSScreenShot.png

# Manually set task bar to hide?

# Auto-updates
# Firefox: https://aus5.mozilla.org
# Chrome:
#   www.google.com/dl/*
#   dl.google.com/*
#   google.com/dl/*
...
# Mozilla Firefox auto-update servers
# 127.0.0.1			aus.mozilla.org
# 127.0.0.1			aus1.mozilla.org
# 127.0.0.1			aus2.mozilla.org
# 127.0.0.1			aus3.mozilla.org
# 127.0.0.1			aus4.mozilla.org
# 127.0.0.1			aus5.mozilla.org

# Necessary import for window maximization
$sig = '[DllImport("user32.dll")] public static extern bool ShowWindowAsync(IntPtr hWnd, int nCmdShow);'
Add-Type -MemberDefinition $sig -name NativeMethods -namespace Win32

$ChocoLog = "C:\users\username\documents\ssl\choco.log"
