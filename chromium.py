...
def chromium(browser, version, case, package, url):
    ...
    try:
    	#os.startfile(url)   ----- When browser is set to default it can work this way. But cannot autmatically set browser to default. webbrowser.get() does not work on win10
    	#time.sleep(3)
